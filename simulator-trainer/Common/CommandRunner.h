...
+ (BOOL)runCommand:(NSString *)command withArguments:(NSArray<NSString *> *)arguments cwd:(NSString * _Nullable)cwdPath stdoutString:(NSString * _Nullable * _Nullable)stdoutString error:(NSError ** _Nullable)errorOut;
